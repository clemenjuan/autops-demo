...
Defines the temporal control flow pattern for agent reasoning. The current
benchmarks use one concrete implementation: SDA.
...
class DecisionProcedure(ABC):
    ...
    Decision procedures define the temporal control flow of agent reasoning.
