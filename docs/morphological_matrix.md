...
Full SSA applicability per N is: AO `5 orgs x 3 onboard reps = 15`; AH `5 orgs x (3 onboard x 7 ground) = 105`; AG `{sas,cmas} x 7 = 14`; CG `{sas,cmas} x symb = 2`, about 136 configs per N. The committed in-scope slice is the AO backbone generated by `scripts/generate_ssa_configs.py`:
