...
Registered as "subsymbolic_eventsat" in the representation factory.

Uses a trained PPO ActorCritic policy (or RandomPolicy in mock mode) to
select operational modes. Works with the fixed SDA decision driver
...
class SubsymbolicEventSat(Representation):
    ...
    def encode_observation(self, observation: Any) -> Dict[str, Any]:
        ...
        feature_dict = {
            ...
            # Orbital lookahead (added by extended src/eventsat/env.py)
