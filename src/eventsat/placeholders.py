...
TODO: replace with the real cores —
  ...
  - ``subsymbolic_scheduler_eventsat``: PPO-trained schedule producer for AG/CG
"""
...
class SubsymbolicSchedulerEventSat(_GroundCellPlaceholder):
    """Placeholder RL ground scheduler.

    Ground paradigms require a whole-pass schedule. Until the learned RL schedule
    producer exists, this delegates to the symbolic greedy scheduler and marks the
    result as a placeholder so board analysis can exclude it from headline claims.
    """
