...
**Experiment configs:** `configs/experiments/eventsat_cen_sda_symb_hd_ah.yaml` (autonomous hybrid), `configs/experiments/eventsat_cen_sda_symb_hd_cg.yaml` (conventional ground)
