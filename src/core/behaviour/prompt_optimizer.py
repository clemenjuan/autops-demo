...
Usage:
    ...
    prompt = optimizer.optimize(source_results_dir="data/results/eventsat_sas_ag_llm-s")
"""
...
class PromptOptimizer:
    ...
    def __init__(self, config: Dict[str, Any] | None = None) -> None:
        ...
        behaviour_cfg = self._config.get("behaviour_config", {})
        self._num_examples: int = behaviour_cfg.get("num_examples", _DEFAULT_NUM_EXAMPLES)
        self._num_candidates: int = behaviour_cfg.get("num_candidates", _DEFAULT_NUM_CANDIDATES)
    ...
    def _get_user_prompt_fn(self) -> Any:
        ...
        if self._repr_type == "agentic_eventsat":
            from src.eventsat.agentic_prompts import format_planning_prompt
            return format_planning_prompt
        from src.eventsat.llm_prompts import format_state_prompt
